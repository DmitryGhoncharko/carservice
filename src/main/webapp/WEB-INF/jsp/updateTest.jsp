...
<div class="container-fluid flex">
  ...
  <div class="row h100">
    <div class="col-md-8 offset-md-2 my-4">
      <h2 class="text-center">Редактировать тест</h2>
      <form action="/controller?command=updateTest" method="post" class="needs-validation" novalidate>
        <!-- Скрытое поле для передачи id теста -->
