        ...
        <div class="col-md-offset-3 col-md-6">
            <form class="form-horizontal needs-validation" action="/controller?command=registrationcmnd" method="post" novalidate>
                ...
                <div class="form-group">
                    <input type="email" class="form-control needs-validation" id="validationServer03" name="login" placeholder="Ваш логин" required>
                    <div class="invalid-feedback">
                        Логин должен быть почтовым адресом
                    </div>
                </div>
